...
const Footer = () => {
  return (
    <div className="bg-marian flex justify-between p-8 text-white w-full flex-col md:flex-row">
      <div className="md:basis-1/3 basis-full hidden md:flex md:flex-col">
        <h3 className="text-2xl sm:text-3xl py-2 font-bold text-white">
      ...
      <div className="md:basis-1/4 px-2 basis-full">
        ...
        <div>
          ...
          <div className="border-b-2 border-y-xan"></div>
